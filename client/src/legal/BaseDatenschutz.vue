...
<template>
	<BaseStatic>
		...
		<p>
			Bei der Reservierung eines Elements für eine Patenschaft werden folgende personenbezogene Daten gespeichert:
		</p>
		<ul>
		...
		<h2>Cookies</h2>
		<p>
			Diese Seite nutzt Cookies ausschließlich für den Login im Admin-Panel.
